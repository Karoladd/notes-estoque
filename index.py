...
class Application:
    ...
    def kit(self):
        ...
        self.nome = Label(self.segundoContainer,width = 100,fg = "blue")
        self.nome["width"] = 60
    ...
    def menu(self):
        ...
        self.nomeLabel["bg"] = "green"
        self.nomeLabel["fg"] = "#fff"
        self.nomeLabel["font"] = ("Arial", "14", "bold")
        ...
        self.autenticar["bg"] = "yellow"
        self.autenticar["font"] = ("Arial", "14", "bold")
        self.autenticar["command"] = self.caixa
        self.autenticar.pack()

        self.sair = Button(self.quintoContainer,text="SAIR", font=self.fontePadrao)
        self.sair["width"] = 20
        self.sair["height"] = 1
        self.sair["bg"] = "red"
        self.sair["fg"] = "#fff"
    ...
    def downloadPF(self):
        ...
        path = r"C:\Users\Karol\Desktop\excel-python\note"
