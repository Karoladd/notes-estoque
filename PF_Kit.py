...
#Variações
picBB = df.loc[df['Codigo'].str.contains('PICBB', na=False)]
picCJ = df.loc[df['Codigo'].str.contains('PICCJ', na=False)]
picCP = df.loc[df['Codigo'].str.contains('PICCP-UY', na=False)]
picFB = df.loc[df['Codigo'].str.contains('PICFB-AR', na=False)]
picFC = df.loc[df['Codigo'].str.contains('PICFC-PY', na=False)]
picFG = df.loc[df['Codigo'].str.contains('PICFG-AR', na=False)]
picGR = df.loc[df['Codigo'].str.contains('PICGR-PY', na=False)]
picLM = df.loc[df['Codigo'].str.contains('PICLM-UY', na=False)]
picNG = df.loc[df['Codigo'].str.contains('PICNG-BR', na=False)]
picPD = df.loc[df['Codigo'].str.contains('PICPD-UY', na=False)]
picPI_C = df.loc[df['Codigo'].str.contains('PICPI-AR-01C', na=False)]
picPI_C = df.loc[df['Codigo'].str.contains('PICPI-AR-01R', na=False)]
picSO = df.loc[df['Codigo'].str.contains('PICSO-UY', na=False)]
picZM = df.loc[df['Codigo'].str.contains('PICZM-BR', na=False)]
picPD = df.loc[df['Codigo'].str.contains('PICPD-UY', na=False)]
...
writer = pd.ExcelWriter('excel/SaldoProdPF.xlsx')
...
if not camarao.empty:
    with open('C:/Users/Karol/Desktop/excel-python/note/PF.txt', 'a') as f:
        f.write("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n")
    camarao.to_csv(r'C:/Users/Karol/Desktop/excel-python/note/PF.txt', header=None, index=None, sep='\t', mode='a')
...
if not picanha.empty:
    picanha.to_csv(r'C:/Users/Karol/Desktop/excel-python/note/PF.txt', header=None, index=None, sep='\t', mode='a')
if not fileCostela.empty:
    with open('C:/Users/Karol/Desktop/excel-python/note/PF.txt', 'a') as f:
        f.write("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n")
    fileCostela.to_csv(r'C:/Users/Karol/Desktop/excel-python/note/PF.txt', header=None, index=None, sep='\t', mode='a') 
if not contFile.empty:
    with open('C:/Users/Karol/Desktop/excel-python/note/PF.txt', 'a') as f:
        f.write("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n")
    contFile.to_csv(r'C:/Users/Karol/Desktop/excel-python/note/PF.txt', header=None, index=None, sep='\t', mode='a')   
...
with open('C:/Users/Karol/Desktop/excel-python/note/PF.txt', 'a', encoding="utf=8") as f:
    f.write("======================================================================================================================================================================================\n")
    f.write("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n")
rodape.to_csv(r'C:/Users/Karol/Desktop/excel-python/note/PF.txt', header=None, index=None, sep='\t', mode='a')
